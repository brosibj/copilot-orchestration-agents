...
4. Write or refresh `plans/{task-slug}/plan.md` from the [plan template](./templates/plan.template.md).
5. Keep the plan actionable:
...
6. If the design is still ambiguous, stop and resolve that ambiguity before finalizing the plan.
