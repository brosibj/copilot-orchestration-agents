...
- **Support-only mode:** return draft content, structure, or edit recommendations to the parent agent. Leave `summary.md` and `worklog.md` untouched unless the prompt explicitly transfers ownership.
...
6. In owner mode, append a short writing entry to `worklog.md`.
