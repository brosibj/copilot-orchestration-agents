...
5. **Build:** Run the project build command (see `.github/docs/project.md` § Build & Validation) — 0 errors, 0 warnings required.
6. **Test:** Run the project test command (see `.github/docs/project.md` § Build & Validation) — regressions (previously passing tests now failing) must be resolved.
