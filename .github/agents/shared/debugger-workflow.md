...
5. **Verify:** Run the build verification from `.github/docs/project.md` § Build & Validation and test verification from `.github/docs/testing.md` § Build & Test Commands.
